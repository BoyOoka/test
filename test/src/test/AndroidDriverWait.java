...
public class AndroidDriverWait extends FluentWait<AndroidDriver> {
   ...
   *
   * @param driver2 The WebDriver instance to pass to the expected conditions
   * @param timeOutInSeconds The timeout in seconds when an expectation is called
   * @see AndroidDriverWait#ignoring(java.lang.Class)
   */
  public AndroidDriverWait(AppiumDriver<WebElement> driver2, long timeOutInSeconds) {
    this(driver2, new SystemClock(), Sleeper.SYSTEM_SLEEPER, timeOutInSeconds, DEFAULT_SLEEP_TIMEOUT);
  }
   ...
   */
  public AndroidDriverWait(AppiumDriver<WebElement> driver2, Clock clock, Sleeper sleeper, long timeOutInSeconds,
      long sleepTimeOut) {
    super((AndroidDriver) driver2, clock, sleeper);
